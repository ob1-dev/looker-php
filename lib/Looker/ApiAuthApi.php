...
class ApiAuthApi
{
     ...
     * @return \OpenAPI\Client\Model\AccessToken|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AccessToken|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function loginRequest($client_id = null, $client_secret = null)
    {
        ...
        if ($client_secret !== null) {
            if('form' === 'form' && is_array($client_secret)) {
                foreach($client_secret as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function loginUserRequest($user_id, $associative = null)
    {
        ...
        // query params
        if ($associative !== null) {
            if('form' === 'form' && is_array($associative)) {
                foreach($associative as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['associative'] = $associative;
            }
        }
