...
class Workspace implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id The unique id of this user workspace. Predefined workspace ids include \"production\" and \"dev\"
     *
     * @return self
     */
     ...
     * Sets projects
     *
     * @param \OpenAPI\Client\Model\Project[]|null $projects The local state of each project in the workspace
     *
     * @return self
     */
