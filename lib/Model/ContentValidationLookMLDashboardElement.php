 ...
 */
class ContentValidationLookMLDashboardElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentValidationLookMLDashboardElement';
     ...
     * Sets lookml_link_id
     *
     * @param string|null $lookml_link_id Link ID of the LookML Dashboard Element
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Title of the LookML Dashboard Element
     *
     * @return self
     */
