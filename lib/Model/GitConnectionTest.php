 ...
 */
class GitConnectionTest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GitConnectionTest';
     ...
     * Sets description
     *
     * @param string|null $description Human readable string describing the test
     *
     * @return self
     */
