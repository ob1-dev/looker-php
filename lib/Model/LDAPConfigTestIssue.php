 ...
 */
class LDAPConfigTestIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LDAPConfigTestIssue';
     ...
     * Sets severity
     *
     * @param string|null $severity Severity of the issue. Error or Warning
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Message describing the issue
     *
     * @return self
     */
