 ...
 */
class DataActionUserState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataActionUserState';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['refresh_time'] = $data['refresh_time'] ?? null;
    }
     ...
     * Sets data
     *
     * @param string|null $data User state data
     *
     * @return self
     */
     ...
     * Sets refresh_time
     *
     * @param int|null $refresh_time Time in seconds until the state needs to be refreshed
     *
     * @return self
     */
