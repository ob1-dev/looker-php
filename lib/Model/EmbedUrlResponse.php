 ...
 */
class EmbedUrlResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmbedUrlResponse';
     ...
     * Sets url
     *
     * @param string|null $url The embed URL. Any modification to this string will make the URL unusable.
     *
     * @return self
     */
