 ...
 */
class LDAPUserAttributeRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LDAPUserAttributeRead';
     ...
     * Sets name
     *
     * @param string|null $name Name of User Attribute in LDAP
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool|null $required Required to be in LDAP assertion for login to be allowed to succeed
     *
     * @return self
     */
