...
class AccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets access_token
     *
     * @param string|null $access_token Access Token used for API calls
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Number of seconds before the token expires
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token Refresh token which can be used to obtain a new access token
     *
     * @return self
     */
