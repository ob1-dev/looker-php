 ...
 */
class LookmlModelExploreFieldEnumeration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LookmlModelExploreFieldEnumeration';
