 ...
 */
class CreateCostEstimate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCostEstimate';
     ...
     * Sets sql
     *
     * @param string|null $sql SQL statement to estimate
     *
     * @return self
     */
