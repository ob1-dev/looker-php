 ...
 */
class GitConnectionTestResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GitConnectionTestResult';
     ...
     * Sets id
     *
     * @param string|null $id A short string, uniquely naming this test
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Additional data from the test
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Either 'pass' or 'fail'
     *
     * @return self
     */
