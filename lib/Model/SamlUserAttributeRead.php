 ...
 */
class SamlUserAttributeRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SamlUserAttributeRead';
     ...
     * Sets name
     *
     * @param string|null $name Name of User Attribute in Saml
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool|null $required Required to be in Saml assertion for login to be allowed to succeed
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Link to saml config
     *
     * @return self
     */
