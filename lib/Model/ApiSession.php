 ...
 */
class ApiSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiSession';
     ...
     * Sets workspace_id
     *
     * @param string|null $workspace_id The id of active workspace for this session
     *
     * @return self
     */
     ...
     * Sets sudo_user_id
     *
     * @param int|null $sudo_user_id The id of the actual user in the case when this session represents one user sudo'ing as another
     *
     * @return self
     */
