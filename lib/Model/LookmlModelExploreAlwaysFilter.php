 ...
 */
class LookmlModelExploreAlwaysFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LookmlModelExploreAlwaysFilter';
