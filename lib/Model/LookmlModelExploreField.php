 ...
 */
class LookmlModelExploreField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'time_interval' => '\OpenAPI\Client\Model\LookmlModelExploreFieldTimeInterval',
        'label' => 'string',
        'label_from_parameter' => 'string',
        'label_short' => 'string',
        'lookml_link' => 'string',
        'map_layer' => '\OpenAPI\Client\Model\LookmlModelExploreFieldMapLayer',
        'measure' => 'bool',
        'name' => 'string',
    ...
    const CATEGORY_MEASURE = 'measure';
    const CATEGORY_DIMENSION = 'dimension';
    const FILL_STYLE_ENUMERATION = 'enumeration';
    const FILL_STYLE_RANGE = 'range';
    const WEEK_START_DAY_MONDAY = 'monday';
    const WEEK_START_DAY_TUESDAY = 'tuesday';
    const WEEK_START_DAY_WEDNESDAY = 'wednesday';
    const WEEK_START_DAY_THURSDAY = 'thursday';
    const WEEK_START_DAY_FRIDAY = 'friday';
    const WEEK_START_DAY_SATURDAY = 'saturday';
    const WEEK_START_DAY_SUNDAY = 'sunday';
     ...
     * @return string[]
     */
    public function getFillStyleAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public function getUserAttributeFilterTypesAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public function getWeekStartDayAllowableValues()
    {
        return [
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['can_filter'] = $data['can_filter'] ?? null;
        $this->container['category'] = $data['category'] ?? null;
        $this->container['default_filter_value'] = $data['default_filter_value'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['dimension_group'] = $data['dimension_group'] ?? null;
        $this->container['enumerations'] = $data['enumerations'] ?? null;
        $this->container['error'] = $data['error'] ?? null;
        $this->container['field_group_label'] = $data['field_group_label'] ?? null;
        $this->container['field_group_variant'] = $data['field_group_variant'] ?? null;
        $this->container['fill_style'] = $data['fill_style'] ?? null;
        $this->container['fiscal_month_offset'] = $data['fiscal_month_offset'] ?? null;
        $this->container['has_allowed_values'] = $data['has_allowed_values'] ?? null;
        $this->container['hidden'] = $data['hidden'] ?? null;
        $this->container['is_filter'] = $data['is_filter'] ?? null;
        $this->container['is_fiscal'] = $data['is_fiscal'] ?? null;
        $this->container['is_numeric'] = $data['is_numeric'] ?? null;
        $this->container['is_timeframe'] = $data['is_timeframe'] ?? null;
        $this->container['can_time_filter'] = $data['can_time_filter'] ?? null;
        $this->container['time_interval'] = $data['time_interval'] ?? null;
        $this->container['label'] = $data['label'] ?? null;
        $this->container['label_from_parameter'] = $data['label_from_parameter'] ?? null;
        $this->container['label_short'] = $data['label_short'] ?? null;
        $this->container['lookml_link'] = $data['lookml_link'] ?? null;
        $this->container['map_layer'] = $data['map_layer'] ?? null;
        $this->container['measure'] = $data['measure'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['strict_value_format'] = $data['strict_value_format'] ?? null;
        $this->container['parameter'] = $data['parameter'] ?? null;
        $this->container['permanent'] = $data['permanent'] ?? null;
        $this->container['primary_key'] = $data['primary_key'] ?? null;
        $this->container['project_name'] = $data['project_name'] ?? null;
        $this->container['requires_refresh_on_sort'] = $data['requires_refresh_on_sort'] ?? null;
        $this->container['scope'] = $data['scope'] ?? null;
        $this->container['sortable'] = $data['sortable'] ?? null;
        $this->container['source_file'] = $data['source_file'] ?? null;
        $this->container['source_file_path'] = $data['source_file_path'] ?? null;
        $this->container['sql'] = $data['sql'] ?? null;
        $this->container['sql_case'] = $data['sql_case'] ?? null;
        $this->container['filters'] = $data['filters'] ?? null;
        $this->container['suggest_dimension'] = $data['suggest_dimension'] ?? null;
        $this->container['suggest_explore'] = $data['suggest_explore'] ?? null;
        $this->container['suggestable'] = $data['suggestable'] ?? null;
        $this->container['suggestions'] = $data['suggestions'] ?? null;
        $this->container['tags'] = $data['tags'] ?? null;
        $this->container['type'] = $data['type'] ?? null;
        $this->container['user_attribute_filter_types'] = $data['user_attribute_filter_types'] ?? null;
        $this->container['value_format'] = $data['value_format'] ?? null;
        $this->container['view'] = $data['view'] ?? null;
        $this->container['view_label'] = $data['view_label'] ?? null;
        $this->container['dynamic'] = $data['dynamic'] ?? null;
        $this->container['week_start_day'] = $data['week_start_day'] ?? null;
        $this->container['times_used'] = $data['times_used'] ?? null;
        $this->container['original_view'] = $data['original_view'] ?? null;
    }
    ...
    public function setUserAttributeFilterTypes($user_attribute_filter_types)
    {
        ...
        if (!is_null($user_attribute_filter_types) && array_diff($user_attribute_filter_types, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
    ...
    {
        $allowedValues = $this->getWeekStartDayAllowableValues();
        if (!is_null($week_start_day) && !in_array($week_start_day, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'week_start_day', must be one of '%s'",
                    $week_start_day,
