 ...
 */
class GroupIdForGroupUserInclusion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupIdForGroupUserInclusion';
