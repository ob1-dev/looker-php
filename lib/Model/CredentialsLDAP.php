 ...
 */
class CredentialsLDAP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CredentialsLDAP';
     ...
     * Sets ldap_dn
     *
     * @param string|null $ldap_dn LDAP Distinguished name for this user (as-of the last login)
     *
     * @return self
     */
     ...
     * Sets ldap_id
     *
     * @param string|null $ldap_id LDAP Unique ID for this user
     *
     * @return self
     */
