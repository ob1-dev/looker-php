 ...
 */
class LookmlModelExploreConditionallyFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LookmlModelExploreConditionallyFilter';
