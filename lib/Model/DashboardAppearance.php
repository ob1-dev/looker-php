 ...
 */
class DashboardAppearance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DashboardAppearance';
    ...
    {
        $this->container['page_side_margins'] = $data['page_side_margins'] ?? null;
     ...
     *
     * @param int|null $page_side_margins Page margin (side) width
     *
     * @return self
     */
     ...
     *
     * @param string|null $page_background_color Background color for the dashboard
     *
     * @return self
     */
     ...
     *
     * @param string|null $tile_title_alignment Title alignment on dashboard tiles
     *
     * @return self
     */
     ...
     *
     * @param int|null $tile_space_between Space between tiles
     *
     * @return self
     */
     ...
     * Sets tile_shadow
     *
     * @param bool|null $tile_shadow Tile shadow on/off
     *
     * @return self
     */
     ...
     * Sets key_color
     *
     * @param string|null $key_color Key color
     *
     * @return self
     */
