 ...
 */
class ContentValidationAlert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentValidationAlert';
     ...
     * Sets id
     *
     * @param int|null $id ID of the alert
     *
     * @return self
     */
