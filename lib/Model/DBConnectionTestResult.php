 ...
 */
class DBConnectionTestResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DBConnectionTestResult';
     ...
     *
     * @param string|null $connection_string JDBC connection string. (only populated in the 'connect' test)
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Result message of test
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of test
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Result code of test
     *
     * @return self
     */
