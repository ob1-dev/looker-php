 ...
 */
class HomepageItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['custom_description'] = $data['custom_description'] ?? null;
        $this->container['custom_image_data_base64'] = $data['custom_image_data_base64'] ?? null;
        $this->container['custom_image_url'] = $data['custom_image_url'] ?? null;
        $this->container['custom_title'] = $data['custom_title'] ?? null;
        $this->container['custom_url'] = $data['custom_url'] ?? null;
        $this->container['dashboard_id'] = $data['dashboard_id'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['favorite_count'] = $data['favorite_count'] ?? null;
        $this->container['homepage_section_id'] = $data['homepage_section_id'] ?? null;
        ...
        $this->container['section_fetch_time'] = $data['section_fetch_time'] ?? null;
        $this->container['title'] = $data['title'] ?? null;
        $this->container['url'] = $data['url'] ?? null;
        $this->container['use_custom_description'] = $data['use_custom_description'] ?? null;
        $this->container['use_custom_image'] = $data['use_custom_image'] ?? null;
        $this->container['use_custom_title'] = $data['use_custom_title'] ?? null;
        $this->container['use_custom_url'] = $data['use_custom_url'] ?? null;
     ...
     *
     * @param int|null $homepage_section_id Associated Homepage Section
     *
     * @return self
     */
