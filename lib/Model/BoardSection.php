...
class BoardSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['board_items'] = $data['board_items'] ?? null;
     ...
     * Sets board_id
     *
     * @param int|null $board_id Id reference to parent board
     *
     * @return self
     */
     ...
     * Sets item_order
     *
     * @param int[]|null $item_order ids of the board items in the order they should be displayed
     *
     * @return self
     */
